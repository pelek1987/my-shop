...
import newsletterFormInputSchema, {NewsletterFormInputType} from "./NewsletterFormInput.schema";
import {useSubscribeToNewsletterMutation} from "../../hooks/mutations/useSubscribeToNewsletterMutation";

const NewsletterForm = () => {
    const {register, handleSubmit} = useForm<NewsletterFormInputType>({
        resolver: yupResolver(newsletterFormInputSchema)
    });
    ...
    return (
        <div className="bg-white">
            <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                ...
                <form onSubmit={onSubmit} className="mt-8 sm:flex">
